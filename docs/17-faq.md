...
8GB 장비로 참석하는 경우에는 행사 전에 반드시 1회 실행 테스트를 끝내야 합니다.
...
더 자세한 기준은 [트러블슈팅 / 최종 체크 / 참고 링크](./16-troubleshooting-and-final-check.md)를 확인해 주세요.
...
먼저 [트러블슈팅 / 최종 체크 / 참고 링크](./16-troubleshooting-and-final-check.md)를 보세요.
