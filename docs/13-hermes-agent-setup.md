...
- 발표자 데모
- 고급 참가자
- 로컬 에이전트, skills, delegation, AI office 워크플로를 직접 구성해 보고 싶은 참가자

## 이 경로를 누구에게는 권하지 않나요?

- 당일 처음 WSL2를 설치해야 하는 Windows 참가자
- 1시간 안에 GUI 중심으로만 간단한 체험을 원하는 참가자
- 에이전트보다 기본 로컬 추론만 빨리 체험하고 싶은 참가자
